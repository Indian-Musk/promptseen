...
app.get('/index.html', (req, res) => {
    ...
    if (req.get('host').includes('Promptseen.co') || process.env.NODE_ENV === 'production') {
...
app.get('/api/blog-posts', (req, res) => {
    ...
    try {
        ...
        const posts = htmlFiles.map(filename => {
            ...
            const author = authorMatch ? authorMatch[1] : 'Prompt seen';
...
function createPromptData(prompt, id) {
  ...
  const promptData = {
    ...
    seoTitle: safePrompt.seoTitle || safePrompt.title || (isVideo ? 'AI Video Prompt - Prompt seen' : 'AI Prompt - Prompt seen'),
...
<body>
    ...
    <footer class="site-footer">
        <div class="footer-container">
            <div class="footer-section">
                <h3>Prompt seen</h3>
                <p>Prompt seen is a platform that offers trending and viral AI prompts for photo editing, video creation, and other creative tasks. It provides users with free, high-quality prompts that can be used with various AI tools, including over 50 AI platforms across image and video generation.</p>
            </div>
            <div class="footer-section">
                <h3>Quick Links</h3>
                <ul class="footer-links">
                    ...
                    <li><a href="https://www.Promptseen.co/ai-detector.html">Prompt Tools</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h3>Resources</h3>
        ...
        <div class="copyright">
            <p>&copy; 2026 Prompt seen. All rights reserved. | AI Prompt & Video Generation Platform</p>
        </div>
    </footer>
    ...
    <script>
        console.log('Initializing Prompt seen page with 50+ AI models');
        ...
        function handleShare(promptId) {
            ...
            if (navigator.share) {
                navigator.share({
                    ...
                    text: 'Check out this AI ' + (isVideo ? 'video' : 'prompt') + ' on Prompt seen',
                    url: promptUrl
                }).catch(() => {
