...
function initSocialSharing() {
  ...
  shareButtons.forEach(button => {
    button.addEventListener('click', function() {
      ...
      const text = encodeURIComponent(`Check out this AI prompt: "${promptTitle}" - ${promptText.substring(0, 100)}...`);
     
      let shareUrl;
     
      switch(platform) {
        case 'whatsapp':
          shareUrl = `https://api.whatsapp.com/send?text=${text} ${pageUrl}`;
          break;
        case 'facebook':
        ...
        case 'instagram':
          ...
          // So we'll copy the text to clipboard and prompt user to paste it
          navigator.clipboard.writeText(`${promptTitle}: ${promptText.substring(0, 200)}...\n\nSee more at: ${window.location.href}`);
          showCopyNotification('Prompt copied! Paste it on Instagram');
          return;
      }
    ...
    promptCard.innerHTML = `
      ...
      <div class="prompt-content">
        ...
        <div class="prompt-share">
          <div class="share-title">Share this prompt:</div>
          <div class="share-buttons">
            <button class="share-btn whatsapp" data-prompt-title="${prompt.title}">
              <i class="fab fa-whatsapp"></i>
            </button>
            <button class="share-btn facebook" data-prompt-title="${prompt.title}">
              <i class="fab fa-facebook-f"></i>
            </button>
            <button class="share-btn instagram" data-prompt-title="${prompt.title}">
